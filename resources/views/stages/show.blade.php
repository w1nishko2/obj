...
@section('content')
    ...
    <div class="container stage-show-container">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tasksTab">
                ...
                @else
                    <div class="row" id="tasksContainer" data-project-id="{{ $project->id }}" data-stage-id="{{ $stage->id }}">
                                                            ...
                                                            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                                                                <div class="position-relative">
                                                                    <img src="{{ $photo->secure_url }}"
                                                                        ...
                                                                        onclick="event.preventDefault(); window.open('{{ $photo->secure_url }}', '_blank', 'noopener,noreferrer');">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (tasksContainer) {
            ...
            let tasksHasMore = {{ $totalTasks > 20 ? 'true' : 'false' }}; // Есть ли еще задачи для загрузки
