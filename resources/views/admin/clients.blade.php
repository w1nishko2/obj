        ...
        <div class="card-body p-0">
            <div id="usersList">
                @foreach($users as $user)
                    @include('admin.partials.user-row', ['user' => $user, 'plans' => $plans])
                @endforeach
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function performSearch() {
        ...
        window.location.href = '{{ route("admin.clients") }}?search=' + encodeURIComponent(searchValue);
    }
    ...
    function loadMoreUsers() {
        ...
        const searchValue = searchInput.value;
        const url = '{{ route("admin.clients") }}?page=' + (currentPage + 1) + '&search=' + encodeURIComponent(searchValue);
