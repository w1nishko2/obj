                            ...
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center gap-2 mb-1">
                                        <h5 class="mb-0 fw-bold">{{ $promo->code }}</h5>
                                        @if($promo->is_active)
                                    ...
                                    <div class="promo-discount">
                                        ...
                                        {{ $promo->discount_percent }}% скидка
                                    </div>
                                    @if($promo->description)
                                        <div class="text-muted small mt-1">{{ $promo->description }}</div>
                                    @endif
                                </div>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('admin.promocodes.analytics', $promo->id) }}">
                                                <i class="bi bi-graph-up me-2"></i>Аналитика
                                            </a>
                                        </li>
                                        <li>
                                            <button class="dropdown-item" onclick="editPromocode({{ $promo->id }})">
                                                <i class="bi bi-pencil me-2"></i>Редактировать
                                            </button>
                                        </li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li>
                                            <button class="dropdown-item text-danger" onclick="deletePromocode({{ $promo->id }})">
                            ...
                            <div class="row g-2 mt-2">
                                <div class="col-6 col-md-3">
                                    <div class="stat-mini">
                                        ...
                                        <div class="stat-mini-value">{{ $promo->stats['total_usages'] }}</div>
                                    </div>
                                </div>
                                <div class="col-6 col-md-3">
                                    <div class="stat-mini">
                                        <div class="stat-mini-label">Выручка</div>
                                        <div class="stat-mini-value">{{ number_format($promo->stats['total_revenue'], 0, ',', ' ') }} ₽</div>
                                    </div>
                                </div>
                                <div class="col-6 col-md-3">
                                    <div class="stat-mini">
                                        <div class="stat-mini-label">Скидка</div>
                                        <div class="stat-mini-value text-danger">{{ number_format($promo->stats['total_discount'], 0, ',', ' ') }} ₽</div>
                                    </div>
                                </div>
                                <div class="col-6 col-md-3">
                                    <div class="stat-mini">
                                        <div class="stat-mini-label">Пользователей</div>
                                        <div class="stat-mini-value">{{ $promo->stats['unique_users'] }}</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-2 small text-muted">
                                    @if($promo->usage_limit)
                                        <div class="col-auto">
                                            ...
                                            Лимит: {{ $promo->usage_count }}/{{ $promo->usage_limit }}
                                        </div>
                                    @endif
                                    @if($promo->expires_at)
                                        <div class="col-auto">
...
function createPromocode() {
    ...
    fetch('{{ route("admin.promocodes.create") }}', {
        method: 'POST',
        headers: {
