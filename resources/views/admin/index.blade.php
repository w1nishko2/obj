...
<div class="minimal-container py-3 py-md-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 mb-md-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.promocodes') }}" class="btn btn-success">
            ...
            <div class="row g-2 g-md-3">
                ...
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-danger">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $usersStats['admins'] }}</div>
                ...
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-success">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $usersStats['foremen'] }}</div>
                ...
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-info">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $usersStats['executors'] }}</div>
                ...
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-warning">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $usersStats['clients'] }}</div>
            ...
            <div class="row g-2 g-md-3">
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-success">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $subscriptionsStats['active'] }}</div>
                ...
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-warning">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $subscriptionsStats['expired'] }}</div>
                ...
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-danger">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $subscriptionsStats['cancelled'] }}</div>
                ...
                <div class="list-group list-group-flush">
                    @foreach($paidPlans as $plan)
                        <div class="list-group-item d-flex justify-content-between align-items-center px-2 px-md-3">
                            <span class="fw-medium">{{ $plan['plan_name'] }}</span>
            ...
            <div class="row g-2 g-md-3">
                <div class="col-12 col-md-4">
                    <div class="stat-card stat-card-success">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ number_format($paymentsStats['total_revenue'], 0, ',', ' ') }} ₽</div>
                ...
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-primary">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $paymentsStats['total_payments'] }}</div>
                ...
                <div class="col-6 col-md-4">
                    <div class="stat-card stat-card-warning">
                        ...
                        <div class="stat-content">
                            <div class="stat-value">{{ $paymentsStats['pending_payments'] }}</div>
