...
<head>
    ...
    <link rel="alternate" hreflang="ru" href="<?php echo e(url('/')); ?>">
...
<!-- /Yandex.Metrika counter -->
        ...
        "@graph": [
            {
                ...
                "logo": {
                    "@type": "ImageObject",
                    "url": "<?php echo e(asset('images/icons/icon-512x512.png')); ?>",
                    "width": 512,
                    "height": 512
                },
                "sameAs": [
            ...
            },
            {
                ...
                "screenshot": "<?php echo e(asset('images/og-image.jpg')); ?>"
            },
            {
                "@type": "WebPage",
                ...
                "primaryImageOfPage": {
                    "@type": "ImageObject",
                    "url": "<?php echo e(asset('images/og-image.jpg')); ?>"
                },
    ...
    <link rel="preload" href="<?php echo e(asset('css/landing.css')); ?>" as="style">
            ...
            <div class="nav-content">
                ...
                <div class="nav-links">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('home')); ?>" class="btn-primary">Личный кабинет</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn-outline">Войти</a>
                        <a href="<?php echo e(route('register')); ?>" class="btn-primary">Попробовать</a>
                    <?php endif; ?>
                </div>
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                ...
                <div class="pricing-card <?php echo e(isset($plan->popular) && $plan->popular ? 'popular' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn-pricing">
                        Выбрать <?php echo e($plan->name); ?>
    ...
    <section class="contact-section">
        <div class="container">
            <div class="contact-wrapper">
                ...
                <form action="<?php echo e(route('landing.contact')); ?>" method="POST" class="contact-form">
                    <?php echo csrf_field(); ?>
    ...
    <footer class="landing-footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. Все права защищены.</p>
                <div class="footer-links">
                    <a href="<?php echo e(url('/privacy-policy')); ?>">Политика конфиденциальности</a>
                    <a href="<?php echo e(url('/terms-of-use')); ?>">Условия использования</a>
                    <a href="<?php echo e(url('/offer')); ?>">Публичная оферта</a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <div class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-content">
            ...
            <nav class="mobile-nav">
                ...
                <a href="#contact">Контакты</a>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('home')); ?>" class="btn-mobile-primary">Личный кабинет</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-mobile-outline">Войти</a>
                    <a href="<?php echo e(route('register')); ?>" class="btn-mobile-primary">Попробовать</a>
                <?php endif; ?>
            </nav>
        </div>
    </div>
