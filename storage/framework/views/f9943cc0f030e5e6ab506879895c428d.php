                ...
                <div class="text-center py-5">
                    ...
                    <div class="card shadow-sm mx-auto" style="max-width: 500px;">
                        <div class="card-body p-4">
                            <h5 class="mb-3">🎁 Бесплатный тариф (14 дней)</h5>
                            ...
                            <a href="<?php echo e(route('pricing.index')); ?>" class="btn btn-success btn-lg w-100">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\work\resources\views\home.blade.php ENDPATH**/ ?>