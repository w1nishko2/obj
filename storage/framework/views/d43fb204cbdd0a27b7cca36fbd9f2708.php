                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-lg-12 text-end">
                            <div class="d-flex flex-wrap gap-2 justify-content-end">
                                ...
                                <?php else: ?>
                                    <?php if(Auth::user()->getRoleInProject($project) && Auth::user()->getRoleInProject($project)->role === 'owner'): ?>
                            ...
                            <div class="modal-body pt-0 d-flex align-items-center justify-content-center flex-grow-1">
                                <div class="wizard-container" style="max-width: 600px; width: 100%;">
                                    <div class="alert alert-warning">
                                        ...
                                        <ul class="mb-0">
                                            <li><?php echo e($stage->tasks->count()); ?> <?php echo e(Str::plural('задача', $stage->tasks->count())); ?></li>
                                            <li><?php echo e($stage->tasks->sum(fn($t) => $t->photos->count())); ?> <?php echo e(Str::plural('фото', $stage->tasks->sum(fn($t) => $t->photos->count()))); ?></li>
                                            <li><?php echo e($stage->tasks->sum(fn($t) => $t->comments->count())); ?> <?php echo e(Str::plural('комментарий', $stage->tasks->sum(fn($t) => $t->comments->count()))); ?></li>
                                            <li><?php echo e($stage->materials->count()); ?> <?php echo e(Str::plural('материал', $stage->materials->count())); ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-fullscreen m-0">
        <div class="modal-content">
            <div class="d-flex flex-column h-100" style="overflow-y: auto;">
                ...
                <div class="modal-footer border-0 justify-content-center">
                    <button type="button" class="minimal-btn minimal-btn-primary" onclick="closeTutorial()">
