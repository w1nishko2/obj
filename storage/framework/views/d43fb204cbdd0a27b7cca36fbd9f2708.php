...
<div class="container project-show-container">
        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-compact mb-0">
                    ...
                    <li class="breadcrumb-item active" title="<?php echo e($project->name); ?>"><?php echo e(Str::limit($project->name, 20)); ?></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <h4 class="mb-0 project-title-mobile"><?php echo e($project->name); ?></h4>
                                
                            </div>
                            <div class="text-muted project-address-mobile"><i class="bi bi-geo-alt"></i> <?php echo e($project->address); ?></div>
                        </div>
                    </div>
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-12">
                            <div class="d-flex justify-content-between mb-2 small text-muted">
                                <span>Прогресс</span>
                                  <?php if($project->status === 'В работе'): ?>
                                <span class="badge bg-primary px-3 py-2"><?php echo e($project->status); ?></span>
                            <?php elseif($project->status === 'На паузе'): ?>
                                <span class="badge bg-warning px-3 py-2"><?php echo e($project->status); ?></span>
                            <?php else: ?>
                                <span class="badge bg-success px-3 py-2"><?php echo e($project->status); ?></span>
                            <?php endif; ?>
                                <strong class="text-dark"><?php echo e($project->progress); ?>%</strong>
                            </div>
                            <div class="progress" style="height: 6px; border-radius: 10px;">
                                <div class="progress-bar" style="width: <?php echo e($project->progress); ?>%; border-radius: 10px;"></div>
                            </div>
                        </div>
                      
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewCosts', $project)): ?>
                            <div class="col-lg-12 ">
                                <strong class="fs-5"><?php echo e(number_format($project->total_cost, 0, ',', ' ')); ?> ₽</strong>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="col-lg-12 text-end">
                            <div class="d-flex flex-wrap gap-2 justify-content-end">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('generateReports', $project)): ?>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="<?php echo e(route('projects.estimate.pdf', $project)); ?>" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <a href="<?php echo e(route('projects.documents.templates', $project)); ?>" class="btn btn-sm btn-outline-success">
                                        <i class="bi bi-file-earmark-text"></i> Документы
                                    </a>
                                <?php else: ?>
                                    <?php if($currentUserRole && $currentUserRole->role === 'owner'): ?>
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('archive', $project)): ?>
                                    <form action="<?php echo e(route('projects.archive', $project)); ?>" method="POST" style="display: inline;">
                                        <?php echo csrf_field(); ?>
    ...
    <ul class="nav nav-tabs mb-4" id="projectTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="stages-tab" data-bs-toggle="tab" 
                ...
                Этапы (<?php echo e($project->stages->count()); ?>)
            </button>
        </li>
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="participants-tab" data-bs-toggle="tab" 
                ...
                Участники (<?php echo e($project->participants->count()); ?>)
            </button>
        </li>
        <?php else: ?>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="contacts-tab" data-bs-toggle="tab" 
                ...
                Контакты (<?php echo e($project->participants->count() + 1); ?>)
            </button>
        </li>
        <?php endif; ?>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="documents-tab" data-bs-toggle="tab" 
                ...
                Документы (<?php echo e($project->documents->count()); ?>)
            </button>
        </li>
    </ul>
    ...
    <div class="tab-content" id="projectTabsContent">
        ...
        <div class="tab-pane fade show active" id="stages" role="tabpanel">
            ...
            <?php else: ?>
                <div class="row" id="stagesContainer" data-project-id="<?php echo e($project->id); ?>">
                    <?php $__currentLoopData = $project->stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 mb-3">
                            <div class="card stage-card position-relative" 
                                 ...
                                 data-delete-url="<?php echo e(route('projects.stages.destroy', [$project, $stage])); ?>"
                                 data-delete-target="#deleteStageModal<?php echo e($stage->id); ?>"
                                 <?php endif; ?>
                                 onclick="window.location.href='<?php echo e(route('stages.show', [$project, $stage])); ?>'">
                                <div class="long-press-indicator"></div>
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <h5 class="card-title"><?php echo e($stage->name); ?></h5>
                                        <?php if($stage->tasks->count() > 0): ?>
                                            <span class="badge bg-info"><?php echo e($stage->tasks->count()); ?> задач</span>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <div onclick="event.stopPropagation()" class="d-flex align-items-center gap-2">
                                            <form action="<?php echo e(route('projects.stages.status', [$project, $stage])); ?>" 
                                                  method="POST" class="d-inline stage-status-form" data-stage-id="<?php echo e($stage->id); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <input type="radio" class="btn-check status-radio" name="status" value="Не начат" 
                                                           id="status-<?php echo e($stage->id); ?>-not-started" 
                                                           <?php echo e($stage->status === 'Не начат' ? 'checked' : ''); ?>

                                                           data-stage-id="<?php echo e($stage->id); ?>">
                                                    <label class="btn btn-outline-secondary px-2 py-1" 
                                                           for="status-<?php echo e($stage->id); ?>-not-started"
                                                           style="font-size: 0.75rem;">
                                                        <i class="bi bi-circle"></i>
                                                    </label>

                                                    <input type="radio" class="btn-check status-radio" name="status" value="В работе" 
                                                           id="status-<?php echo e($stage->id); ?>-in-progress" 
                                                           <?php echo e($stage->status === 'В работе' ? 'checked' : ''); ?>

                                                           data-stage-id="<?php echo e($stage->id); ?>">
                                                    <label class="btn btn-outline-primary px-2 py-1" 
                                                           for="status-<?php echo e($stage->id); ?>-in-progress"
                                                           style="font-size: 0.75rem;">
                                                        <i class="bi bi-hourglass-split"></i>
                                                    </label>

                                                    <input type="radio" class="btn-check status-radio" name="status" value="Готово" 
                                                           id="status-<?php echo e($stage->id); ?>-done" 
                                                           <?php echo e($stage->status === 'Готово' ? 'checked' : ''); ?>

                                                           data-stage-id="<?php echo e($stage->id); ?>">
                                                    <label class="btn btn-outline-success px-2 py-1" 
                                                           for="status-<?php echo e($stage->id); ?>-done"
                                                           style="font-size: 0.75rem;">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewCosts', $project)): ?>
                                                <?php if($stage->total_cost > 0): ?>
                                                    <span class="badge bg-light text-dark">
                                                        <i class="bi bi-currency-dollar"></i> <?php echo e(number_format($stage->total_cost, 0, ',', ' ')); ?> ₽
                                                    </span>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('createStages', $project)): ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('createStages', $project)): ?>
                ...
                <button type="button" class="d-none" id="triggerDeleteStage<?php echo e($stage->id); ?>" data-bs-toggle="modal" data-bs-target="#deleteStageModal<?php echo e($stage->id); ?>"></button>
                <div class="modal fade" id="deleteStageModal<?php echo e($stage->id); ?>" tabindex="-1">
                    <div class="modal-dialog modal-fullscreen m-0">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pt-0 d-flex align-items-center justify-content-center flex-grow-1">
                                <div class="wizard-container" style="max-width: 600px; width: 100%;">
                                    <div class="alert alert-warning">
                                        <h5 class="alert-heading"><?php echo e($stage->name); ?></h5>
                                        <hr>
                                        <p class="mb-1"><strong>Будет удалено:</strong></p>
                                        <ul class="mb-0">
                                            <li><?php echo e($stage->tasks_count ?? $stage->tasks->count()); ?> <?php echo e(Str::plural('задача', $stage->tasks_count ?? $stage->tasks->count())); ?></li>
                                            <li><?php echo e($stage->tasks->sum('photos_count')); ?> <?php echo e(Str::plural('фото', $stage->tasks->sum('photos_count'))); ?></li>
                                            <li><?php echo e($stage->tasks->sum('comments_count')); ?> <?php echo e(Str::plural('комментарий', $stage->tasks->sum('comments_count'))); ?></li>
                                            <li><?php echo e($stage->materials_count ?? $stage->materials->count()); ?> <?php echo e(Str::plural('материал', $stage->materials_count ?? $stage->materials->count())); ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer border-0 justify-content-center">
                                ...
                                <form action="<?php echo e(route('projects.stages.destroy', [$project, $stage])); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                    ...
                    <?php $__currentLoopData = $project->participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="participant-card-wrapper position-relative"
                                 <?php if(!$isOwnerParticipant): ?>
                                 data-long-press="true"
                                 data-participant-id="<?php echo e($participant->id); ?>"
                                 data-remove-modal="#removeParticipantModal<?php echo e($participant->id); ?>"
                                 <?php endif; ?>>
                                <?php if(!$isOwnerParticipant): ?>
                                    <div class="long-press-indicator"></div>
                                <?php endif; ?>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><?php echo e($participant->name); ?></h6>
                                                <p class="mb-1 text-muted small">
                                                    <i class="bi bi-telephone"></i> <?php echo e($participant->phone); ?>

                                                </p>
                                                <?php if($participant->user_id): ?>
                                                    <?php if($participantUserRole): ?>
                                                        <span class="badge bg-<?php echo e($participantUserRole->role === 'owner' ? 'primary' : ($participantUserRole->role === 'client' ? 'info' : 'success')); ?>">
                                                            <?php echo e($participantUserRole->role === 'owner' ? 'Владелец' : ($participantUserRole->role === 'client' ? 'Клиент' : 'Исполнитель')); ?>
                                            ...
                                            <a href="tel:<?php echo e($participant->phone); ?>" class="btn btn-sm btn-outline-primary">
                        ...
                        <?php if(!$isOwnerParticipant): ?>
                            ...
                            <div class="modal fade" id="removeParticipantModal<?php echo e($participant->id); ?>" tabindex="-1">
                                <div class="modal-dialog modal-fullscreen m-0">
                                    <div class="modal-content">
                                        <form action="<?php echo e(route('projects.participants.remove', [$project, $participant])); ?>" method="POST" class="d-flex flex-column h-100">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <div class="modal-header border-0 pb-2">
                                                <button type="button" class="btn-close position-absolute top-0 end-0 m-3" data-bs-dismiss="modal"></button>
                                            ...
                                            <div class="modal-body pt-0 d-flex align-items-center justify-content-center flex-grow-1">
                                                <div class="wizard-container text-center" style="max-width: 600px;">
                                                    ...
                                                    <p class="mb-2"><strong><?php echo e($participant->name); ?></strong></p>
                                                    <p class="text-muted mb-2"><?php echo e($participant->phone); ?></p>
                                                    <p class="text-muted">
        ...
        <div class="tab-pane fade" id="contacts" role="tabpanel">
            ...
            <div class="row">
                ...
                <?php if($foreman && !$isExecutor): ?>
                <div class="col-md-6 mb-3">
                    <div class="card border-primary">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    <h6 class="mb-1"><?php echo e($foreman->name); ?></h6>
                                    <p class="mb-1 text-muted small">
                                        <i class="bi bi-telephone"></i> <?php echo e($foreman->phone); ?>

                                    </p>
                                    <span class="badge bg-primary">Прораб</span>
                                </div>
                                <a href="tel:<?php echo e($foreman->phone); ?>" class="btn btn-sm btn-outline-primary">
                                    <i class="bi bi-telephone-fill"></i>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <?php if($participant->user_id): ?>
                                            <?php if($participantUserRole): ?>
                                                <span class="badge bg-<?php echo e($participantUserRole->role === 'client' ? 'info' : 'success'); ?>">
                                                    <?php echo e($participantUserRole->role === 'client' ? 'Клиент' : 'Исполнитель'); ?>

                                                </span>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <span class="badge bg-secondary"><?php echo e($participant->role ?? 'Участник'); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <a href="tel:<?php echo e($participant->phone); ?>" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-telephone-fill"></i>
            ...
            <?php if(!$foreman && $project->participants->isEmpty()): ?>
                <div class="alert alert-info">
        ...
        <div class="tab-pane fade" id="documents" role="tabpanel">
            ...
            <?php if($project->documents->isEmpty()): ?>
                <div class="alert alert-info">
                    У этого проекта пока нет документов
                </div>
            <?php else: ?>
                <div class="row">
                    <?php $__currentLoopData = $project->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start mb-2">
                                        <i class="bi <?php echo e($document->file_icon); ?> fs-1 text-primary me-3"></i>
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1"><?php echo e($document->name); ?></h6>
                                            <small class="text-muted"><?php echo e($document->file_size_formatted); ?></small>
                                        </div>
                                    </div>

                                    <?php if($document->description): ?>
                                        <p class="small text-muted mb-2"><?php echo e($document->description); ?></p>
                                    <?php endif; ?>

                                    <div class="small text-muted mb-3">
                                        <div>Загрузил: <?php echo e($document->uploader->name); ?></div>
                                        <div><?php echo e($document->created_at->format('d.m.Y H:i')); ?></div>
                                    </div>

                                    <div class="d-flex gap-2">
                                        <a href="<?php echo e($document->secure_url); ?>" 
                                        ...
                                        ?>
                                        <?php if($canDeleteDoc): ?>
                                            <form action="<?php echo e(route('projects.documents.delete', [$project, $document->id])); ?>" 
                                                  method="POST" 
...
<div class="modal fade" id="addParticipantModal" tabindex="-1">
    <div class="modal-dialog modal-fullscreen m-0">
        <div class="modal-content">
            <form action="<?php echo e(route('projects.participants.add', $project)); ?>" method="POST" class="d-flex flex-column h-100">
                <?php echo csrf_field(); ?>
                <div class="modal-header border-0 pb-2">
                    <button type="button" class="btn-close position-absolute top-0 end-0 m-3" data-bs-dismiss="modal"></button>
                </div>
...
<div class="modal fade" id="uploadDocumentModal" tabindex="-1">
    <div class="modal-dialog modal-fullscreen m-0">
        <div class="modal-content">
            <form action="<?php echo e(route('projects.documents.upload', $project)); ?>" method="POST" enctype="multipart/form-data" id="uploadDocumentForm" class="d-flex flex-column h-100">
                <?php echo csrf_field(); ?>
                <div class="modal-header border-0 pb-2">
                    <button type="button" class="btn-close position-absolute top-0 end-0 m-3" data-bs-dismiss="modal"></button>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const projectId = <?php echo json_encode($project->id, 15, 512) ?>;
    ...
    <?php if(session('stage_id')): ?>
        setTimeout(function() {
            const stageElement = document.getElementById('stage-<?php echo e(session("stage_id")); ?>');
            if (stageElement) {
...
<?php if(Auth::user()->isForemanOfProject($project)): ?>
<div class="modal fade" id="createStageModal" tabindex="-1">
    <div class="modal-dialog modal-fullscreen m-0">
        <div class="modal-content">
            <form action="<?php echo e(route('projects.stages.store', $project)); ?>" method="POST" class="d-flex flex-column h-100">
                <?php echo csrf_field(); ?>
                <div class="modal-header border-0 pb-2">
                    <button type="button" class="btn-close position-absolute top-0 end-0 m-3" data-bs-dismiss="modal"></button>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\work\resources\views\projects\show.blade.php ENDPATH**/ ?>