    ...
    <nav class="landing-nav">
        <div class="nav-container">
            ...
            <div class="nav-links">
                ...
                <a href="<?php echo e(url('/#features')); ?>" class="nav-link">Возможности</a>
                <a href="<?php echo e(url('/#pricing')); ?>" class="nav-link">Тарифы</a>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('home')); ?>" class="nav-cta">Мои проекты</a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="nav-cta">Начать бесплатно</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <footer>
        <div class="footer-content">
            <div class="footer-links">
                <a href="<?php echo e(url('/')); ?>" class="footer-link">Главная</a>
                <a href="<?php echo e(url('/#features')); ?>" class="footer-link">Возможности</a>
                <a href="<?php echo e(url('/#pricing')); ?>" class="footer-link">Тарифы</a>
...
<?php /**PATH C:\OSPanel\domains\work\resources\views\investors_old.blade.php ENDPATH**/ ?>