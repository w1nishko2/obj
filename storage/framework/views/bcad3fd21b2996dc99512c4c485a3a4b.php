...
<body>
    ...
    <nav class="nav">
        <div class="nav-inner">
            <a href="<?php echo e(url('/')); ?>" class="logo">💼 Объект+</a>
            <div class="nav-right">
                <a href="<?php echo e(url('/')); ?>" class="nav-link">Главная</a>
                <a href="<?php echo e(url('/#features')); ?>" class="nav-link">Возможности</a>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('home')); ?>" class="btn-nav">Мои проекты</a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="btn-nav">Начать</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
...
<?php /**PATH C:\OSPanel\domains\work\resources\views\investors.blade.php ENDPATH**/ ?>