...
<div class="minimal-container py-4">
    <div class="payment-success-page">
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($payment->paid_at->format('d.m.Y H:i')); ?></td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <?php if($payment->status === 'succeeded' && $payment->subscription): ?>
        <div class="subscription-info-card mt-3">
            ...
            <p><strong>Начало:</strong> <?php echo e($payment->subscription->started_at->format('d.m.Y H:i')); ?></p>
            <?php if($payment->subscription->expires_at): ?>
            <p><strong>Истекает:</strong> <?php echo e($payment->subscription->expires_at->format('d.m.Y H:i')); ?></p>
            <?php else: ?>
        ...
        <div class="text-center mt-4">
            <?php if($payment->status === 'succeeded'): ?>
                ...
                <a href="<?php echo e(route('payment.history')); ?>" class="btn btn-outline-secondary btn-lg ms-2">
                    <i class="bi bi-clock-history"></i> История платежей
                </a>
            <?php elseif($payment->status === 'pending'): ?>
                <a href="<?php echo e(route('pricing.index')); ?>" class="btn btn-secondary btn-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\work\resources\views\payment\success.blade.php ENDPATH**/ ?>